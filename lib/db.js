...
export const db = {
    ...
    findPaged: async (collection, query = {}, skip = 0, limit = 50) => {
        await dbConnect();
        const Model = models[collection];
    ...
    update: async (collection, query, update) => {
        ...
        // Strip immutable/managed fields to avoid Mongoose/MongoDB errors
        const { _id, __v, createdAt, updatedAt, ...updateData } = update;
